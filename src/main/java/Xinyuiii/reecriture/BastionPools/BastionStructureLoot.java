...
public class BastionStructureLoot {
    ...
    // For version 1.21.10+
    public static final HashMap<String, List<LootTable>> STRUCTURE_LOOT_1_21_10 = new HashMap<>() {{
        ...
        this.put("treasure/bases/centers/center_0", List.of(NewLootTables.BASTION_TREASURE_CHEST_1_21_10));
        this.put("treasure/bases/centers/center_1", List.of(NewLootTables.BASTION_TREASURE_CHEST_1_21_10, NewLootTables.BASTION_TREASURE_CHEST_1_21_10));
        this.put("treasure/bases/centers/center_2", List.of(NewLootTables.BASTION_TREASURE_CHEST_1_21_10));
        this.put("treasure/bases/centers/center_3", List.of(NewLootTables.BASTION_TREASURE_CHEST_1_21_10));
        this.put("treasure/bases/lava_basin", List.of());
        this.put("treasure/brains/center_brain", List.of());
        this.put("treasure/connectors/center_to_wall_middle", List.of());
        this.put("treasure/connectors/center_to_wall_top", List.of());
